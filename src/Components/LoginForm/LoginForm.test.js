...
describe('LoginForm', () => {
    it('Should render a login form', () => {
        const router = <BrowserRouter> <LoginForm /> </BrowserRouter>;
    ...
    it('Should invoke loginUser method when input fields are complete and button is clicked', () => {
        ...
        const { getByText, getByPlaceholderText } = render(<BrowserRouter><LoginForm
    ...
    it('Should display an error message if a user tries to log in without all forms completed', () => {
        const { getByText, getByPlaceholderText } = render(<BrowserRouter><LoginForm /></BrowserRouter>);
